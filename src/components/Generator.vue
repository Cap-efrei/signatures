    ...
    <form class="form-horizontal">
      <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-10">
            <input class="form-control" id="inputEmail" placeholder="john.doe@capefrei.fr" type="text" v-model="inputEmail" v-on:focus="showMail()">
          </div>
        </div>
    ...
    <div class="panel panel-default first">
      ...
      <div class="panel-body" id="signature">
        <div style="float: left; margin: 2px 5px 5px 0px; padding-right: 5px; display: block;">
          <img src="http://capefrei.fr/wp-content/uploads/2017/10/LogoText.png" height="90px">
        </div>
        <div style="margin-top:0px; margin-left: 110px">
          <p style="font-family: Helvetica, sans-serif; font-size: 12px; line-height: 14px; color: #333; margin-top:0; margin-left:0; padding-left:0;">
            ...
            <span v-if="displayRole">/ {{ inputRole }} Cap Efrei</span>
            <span v-else>/ Président Cap Efrei</span><br>
            <span v-if="displayMail"> <a v-bind:href="'mailto:' +  inputEmail" style="color:#3684c8;">{{ inputEmail }}</a></span>
            <span v-else><a href="mailto:john.doe@capefrei.fr" style="color:#3684c8;">john.doe@capefrei.fr</a></span><br>
          ...
          <p style="font-family: Helvetica, sans-serif; font-size: 12px; line-height: 14px; color: rgb(51, 51, 51); margin-top: 0px;">
            ...
            <span><a href="http://capefrei.fr/" style="color:#3684c8;" rel="nofollow" target="_blank">http://capefrei.fr/</a></span> <br>
            <span><a href="http://capefrei.fr/" style="color:#3684c8;" rel="nofollow" target="_blank">http://capefrei.fr/</a></span> <br>
          </p>
        </div>
      </div>
